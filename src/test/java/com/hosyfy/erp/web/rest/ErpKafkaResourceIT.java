...
import com.hosyfy.erp.ErpApp;
import com.hosyfy.erp.config.SecurityBeanOverrideConfiguration;
import com.hosyfy.erp.service.ErpKafkaProducer;
import com.hosyfy.erp.service.ErpKafkaConsumer;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, ErpApp.class})
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class ErpKafkaResourceIT {
    ...
    @Autowired
    private ErpKafkaProducer producer;

    @Autowired
    private ErpKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        ErpKafkaResource kafkaResource = new ErpKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/erp-kafka/publish?message=test"))
